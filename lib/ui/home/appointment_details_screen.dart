...
class AppointmentDetailsScreen extends StatelessWidget {
  ...
  const AppointmentDetailsScreen({
    ...
    this.additionalInfo = 'Please arrive 15 minutes early and bring your medical records.',
  });
            ...
            Card(color: whiteColor,
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SectionContent(context: context, title: 'Doctor:', content: doctorName, icon: Icons.person),
                    const Divider(),
                    SectionContent(context: context, title: 'Date:', content: appointmentDate, icon: Icons.calendar_today),
                    const Divider(),
                    SectionContent(context: context, title: 'Time:', content: appointmentTime, icon: Icons.access_time),
                    const Divider(),
